class FundamentalAccountingConcepts:               

    def __init__(self,xbrl):
        '''
        Deprecated due to convoluted organizational structure. Use XBRL.fundamentalAccountingConcepts() instead.
        '''               
        self.xbrl = xbrl
        
        xbrl.logger.debug("Balance Sheet Date (document period end date): %s" % self.xbrl.fields['BalanceSheetDate'])
        xbrl.logger.debug("Income Statement Period (YTD, current period, period start date): %s to %s" % (self.xbrl.fields['IncomeStatementPeriodYTD'], self.xbrl.fields['BalanceSheetDate']))
        
        xbrl.logger.debug("Context ID for document period focus (instants): %s" % self.xbrl.fields['ContextForInstants'])
        xbrl.logger.debug("Context ID for YTD period (durations): %s" % self.xbrl.fields['ContextForDurations'])
        xbrl.logger.debug(" ")
        ...
        if lngBSCheck1:
            xbrl.logger.debug("BS1: Equity(" + str(self.xbrl.fields['Equity']) + ") = EquityAttributableToParent(" + str(self.xbrl.fields['EquityAttributableToParent']) + ") , EquityAttributableToNoncontrollingInterest(" + str(self.xbrl.fields['EquityAttributableToNoncontrollingInterest']) + "): " + str(lngBSCheck1))
        if lngBSCheck2:
            xbrl.logger.debug("BS2: Assets(" + str(self.xbrl.fields['Assets']) + ") = LiabilitiesAndEquity(" + str(self.xbrl.fields['LiabilitiesAndEquity']) + "): " + str(lngBSCheck2))
        if lngBSCheck3:
            xbrl.logger.debug("BS3: Assets(" + str(self.xbrl.fields['Assets']) + ") = CurrentAssets(" + str(self.xbrl.fields['CurrentAssets']) + ") , NoncurrentAssets(" + str(self.xbrl.fields['NoncurrentAssets']) + "): " + str(lngBSCheck3))
        if lngBSCheck4:
            xbrl.logger.debug("BS4: Liabilities(" + str(self.xbrl.fields['Liabilities']) + ")= CurrentLiabilities(" + str(self.xbrl.fields['CurrentLiabilities']) + ") , NoncurrentLiabilities(" + str(self.xbrl.fields['NoncurrentLiabilities']) + "): " + str(lngBSCheck4))
        if lngBSCheck5:
            xbrl.logger.debug("BS5: Liabilities and Equity(" + str(self.xbrl.fields['LiabilitiesAndEquity']) + ")= Liabilities(" + str(self.xbrl.fields['Liabilities']) + ") , CommitmentsAndContingencies(" + str(self.xbrl.fields['CommitmentsAndContingencies']) + "), TemporaryEquity(" + str(self.xbrl.fields['TemporaryEquity']) + "), Equity(" + str(self.xbrl.fields['Equity']) + "): " + str(lngBSCheck5))
        ...
        if lngIS1:
            xbrl.logger.debug("IS1: GrossProfit(" + str(self.xbrl.fields['GrossProfit']) + ") = Revenues(" + str(self.xbrl.fields['Revenues']) + ") - CostOfRevenue(" + str(self.xbrl.fields['CostOfRevenue']) + "): " + str(lngIS1))
        if lngIS2:
            xbrl.logger.debug("IS2: OperatingIncomeLoss(" + str(self.xbrl.fields['OperatingIncomeLoss']) + ") = GrossProfit(" + str(self.xbrl.fields['GrossProfit']) + ") - OperatingExpenses(" + str(self.xbrl.fields['OperatingExpenses']) + ") , OtherOperatingIncome(" + str(self.xbrl.fields['OtherOperatingIncome']) + "): " + str(lngIS2))
        if lngIS3:        
            xbrl.logger.debug("IS3: IncomeBeforeEquityMethodInvestments(" + str(self.xbrl.fields['IncomeBeforeEquityMethodInvestments']) + ") = OperatingIncomeLoss(" + str(self.xbrl.fields['OperatingIncomeLoss']) + ") - NonoperatingIncomeLoss(" + str(self.xbrl.fields['NonoperatingIncomeLoss']) + "), InterestAndDebtExpense(" + str(self.xbrl.fields['InterestAndDebtExpense']) + "): " + str(lngIS3))
        if lngIS4:
            xbrl.logger.debug("IS4: IncomeFromContinuingOperationsBeforeTax(" + str(self.xbrl.fields['IncomeFromContinuingOperationsBeforeTax']) + ") = IncomeBeforeEquityMethodInvestments(" + str(self.xbrl.fields['IncomeBeforeEquityMethodInvestments']) + ") , IncomeFromEquityMethodInvestments(" + str(self.xbrl.fields['IncomeFromEquityMethodInvestments']) + "): " + str(lngIS4))
        
        if lngIS5:
            xbrl.logger.debug("IS5: IncomeFromContinuingOperationsAfterTax(" + str(self.xbrl.fields['IncomeFromContinuingOperationsAfterTax']) + ") = IncomeFromContinuingOperationsBeforeTax(" + str(self.xbrl.fields['IncomeFromContinuingOperationsBeforeTax']) + ") - IncomeTaxExpenseBenefit(" + str(self.xbrl.fields['IncomeTaxExpenseBenefit']) + "): " + str(lngIS5))
        if  lngIS6:
            xbrl.logger.debug("IS6: NetIncomeLoss(" + str(self.xbrl.fields['NetIncomeLoss']) + ") = IncomeFromContinuingOperationsAfterTax(" + str(self.xbrl.fields['IncomeFromContinuingOperationsAfterTax']) + ") , IncomeFromDiscontinuedOperations(" + str(self.xbrl.fields['IncomeFromDiscontinuedOperations']) + ") , ExtraordaryItemsGainLoss(" + str(self.xbrl.fields['ExtraordaryItemsGainLoss']) + "): " + str(lngIS6))
        if lngIS7:
            xbrl.logger.debug("IS7: NetIncomeLoss(" + str(self.xbrl.fields['NetIncomeLoss']) + ") = NetIncomeAttributableToParent(" + str(self.xbrl.fields['NetIncomeAttributableToParent']) + ") , NetIncomeAttributableToNoncontrollingInterest(" + str(self.xbrl.fields['NetIncomeAttributableToNoncontrollingInterest']) + "): " + str(lngIS7))
        if lngIS8:
            xbrl.logger.debug("IS8: NetIncomeAvailableToCommonStockholdersBasic(" + str(self.xbrl.fields['NetIncomeAvailableToCommonStockholdersBasic']) + ") = NetIncomeAttributableToParent(" + str(self.xbrl.fields['NetIncomeAttributableToParent']) + ") - PreferredStockDividendsAndOtherAdjustments(" + str(self.xbrl.fields['PreferredStockDividendsAndOtherAdjustments']) + "): " + str(lngIS8))
        if lngIS9:
            xbrl.logger.debug("IS9: ComprehensiveIncome(" + str(self.xbrl.fields['ComprehensiveIncome']) + ") = ComprehensiveIncomeAttributableToParent(" + str(self.xbrl.fields['ComprehensiveIncomeAttributableToParent']) + ") , ComprehensiveIncomeAttributableToNoncontrollingInterest(" + str(self.xbrl.fields['ComprehensiveIncomeAttributableToNoncontrollingInterest']) + "): " + str(lngIS9))
        if lngIS10:
            xbrl.logger.debug("IS10: ComprehensiveIncome(" + str(self.xbrl.fields['ComprehensiveIncome']) + ") = NetIncomeLoss(" + str(self.xbrl.fields['NetIncomeLoss']) + ") , OtherComprehensiveIncome(" + str(self.xbrl.fields['OtherComprehensiveIncome']) + "): " + str(lngIS10))
        if lngIS11:
            xbrl.logger.debug("IS11: OperatingIncomeLoss(" + str(self.xbrl.fields['OperatingIncomeLoss']) + ") = Revenues(" + str(self.xbrl.fields['Revenues']) + ") - CostsAndExpenses(" + str(self.xbrl.fields['CostsAndExpenses']) + ") , OtherOperatingIncome(" + str(self.xbrl.fields['OtherOperatingIncome']) + "): " + str(lngIS11))
        ...
        if lngCF1:
            xbrl.logger.debug("CF1: NetCashFlow(" + str(self.xbrl.fields['NetCashFlow']) + ") = (NetCashFlowsOperating(" + str(self.xbrl.fields['NetCashFlowsOperating']) + ") , (NetCashFlowsInvesting(" + str(self.xbrl.fields['NetCashFlowsInvesting']) + ") , (NetCashFlowsFinancing(" + str(self.xbrl.fields['NetCashFlowsFinancing']) + ") , ExchangeGainsLosses(" + str(self.xbrl.fields['ExchangeGainsLosses']) + "): " + str(lngCF1))
        if lngCF2:
            xbrl.logger.debug("CF2: NetCashFlowsContinuing(" + str(self.xbrl.fields['NetCashFlowsContinuing']) + ") = NetCashFlowsOperatingContinuing(" + str(self.xbrl.fields['NetCashFlowsOperatingContinuing']) + ") , NetCashFlowsInvestingContinuing(" + str(self.xbrl.fields['NetCashFlowsInvestingContinuing']) + ") , NetCashFlowsFinancingContinuing(" + str(self.xbrl.fields['NetCashFlowsFinancingContinuing']) + "): " + str(lngCF2))
        if lngCF3:
            xbrl.logger.debug("CF3: NetCashFlowsDiscontinued(" + str(self.xbrl.fields['NetCashFlowsDiscontinued']) + ") = NetCashFlowsOperatingDiscontinued(" + str(self.xbrl.fields['NetCashFlowsOperatingDiscontinued']) + ") , NetCashFlowsInvestingDiscontinued(" + str(self.xbrl.fields['NetCashFlowsInvestingDiscontinued']) + ") , NetCashFlowsFinancingDiscontinued(" + str(self.xbrl.fields['NetCashFlowsFinancingDiscontinued']) + "): " + str(lngCF3))
        if lngCF4:
            xbrl.logger.debug("CF4: NetCashFlowsOperating(" + str(self.xbrl.fields['NetCashFlowsOperating']) + ") = NetCashFlowsOperatingContinuing(" + str(self.xbrl.fields['NetCashFlowsOperatingContinuing']) + ") , NetCashFlowsOperatingDiscontinued(" + str(self.xbrl.fields['NetCashFlowsOperatingDiscontinued']) + "): " + str(lngCF4))
        if lngCF5:
            xbrl.logger.debug("CF5: NetCashFlowsInvesting(" + str(self.xbrl.fields['NetCashFlowsInvesting']) + ") = NetCashFlowsInvestingContinuing(" + str(self.xbrl.fields['NetCashFlowsInvestingContinuing']) + ") , NetCashFlowsInvestingDiscontinued(" + str(self.xbrl.fields['NetCashFlowsInvestingDiscontinued']) + "): " + str(lngCF5))
        if lngCF6:
            xbrl.logger.debug("CF6: NetCashFlowsFinancing(" + str(self.xbrl.fields['NetCashFlowsFinancing']) + ") = NetCashFlowsFinancingContinuing(" + str(self.xbrl.fields['NetCashFlowsFinancingContinuing']) + ") , NetCashFlowsFinancingDiscontinued(" + str(self.xbrl.fields['NetCashFlowsFinancingDiscontinued']) + "): " + str(lngCF6))
